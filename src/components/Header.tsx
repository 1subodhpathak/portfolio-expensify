...
const Header = ({ toggleEasterEgg, toggleSidebar, isSidebarOpen }: HeaderProps) => {
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <button 
              ...
              className="w-10 h-10 bg-expensify-green rounded-full flex items-center justify-center group relative cursor-pointer"
            >
