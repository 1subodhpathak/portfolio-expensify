...
const Header = ({ toggleEasterEgg }: HeaderProps) => {
  ...
  return (
    <header className="bg-expensify-darkgreen border-b border-expensify-buttonGreen">
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          {/* Logo and Title */}
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 bg-expensify-green rounded-lg flex items-center justify-center">
